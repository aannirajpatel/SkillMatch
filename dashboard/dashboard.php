...
?>
  ...
  <!-- add php here -->
<?php
$vishva =$_SESSION['username'];
$result = mysqli_query($con,"SELECT skillname, skilllevel FROM skills WHERE reg_no='$vishva'");
...
<?php
$vishva =$_SESSION['username'];
$rl = mysqli_query($con,"SELECT language_name, lang_level FROM languages WHERE reg_no='$vishva'");
...
<!-- ========================================================== new section ===================== -->
 ...
 <h3>Education</h3>
  ...
  <!-- add php here -->
<?php
$redu = mysqli_query($con,"SELECT institute_name, institute_board, branch, institute_address, joined_year, end_year FROM education WHERE reg_no='$vishva'");
...
<h3>Internships</h3>
  ...
  <!-- add php here -->
<?php
$rint = mysqli_query($con,"SELECT recuitor, istart, iend FROM internships WHERE reg_no='$vishva'");
...
<h3>Publications</h3>
  ...
  <!-- add php here -->
<?php
$rpub = mysqli_query($con,"SELECT publication_domain, publication_title, published_in, pub_year FROM publications WHERE reg_no='$vishva'");
...
<h3>Projects</h3>
  ...
  <!-- add php here -->
<?php
$rproj = mysqli_query($con,"SELECT project_domain, project_title FROM projects WHERE reg_no='$vishva'");
...
<h3>Certificates</h3>
  ...
  <!-- add php here -->
<?php
$rcer = mysqli_query($con,"SELECT certificate_field, issued_by, certified_year, certificate_URL FROM certificate WHERE reg_no='$vishva'");
...
<h3>Clubs</h3>
  ...
  <!-- add php here -->
<?php
$rclub = mysqli_query($con,"SELECT club_name FROM clubs WHERE reg_no='$vishva'");
