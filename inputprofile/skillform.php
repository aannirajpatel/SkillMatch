                     ...
                     <form name="add_name" id="add_name">  
                               ...
                               <table id="dynamic_field">  
                                    ...
                                    <tr>  
                                         ...
                                         <td><input type="text" name="name[]" placeholder="Enter your Skill Name" class="form-control name_list" /></td>  
										 <td><input type="text" name="num[]" placeholder="Enter your Skill Level (1-9)" class="form-control num_list" /></td>  
...
<html>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="Enter your Skill Name" class="form-control name_list" /></td><td><input type="text" name="num[]" placeholder="Enter your Skill Level (1-9)" class="form-control num_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
      ...
      $('#submit').click(function(){            
           $.ajax({  
                ...
                {  
                     alert(data);  
                     $('#add_name')[0].reset();  
                    window.location.replace("languageform.php");
                }  
           });  
      });
      $('#skip').click(function(){
