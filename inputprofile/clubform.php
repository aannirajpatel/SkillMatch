...
<body>
    ...
    <header>
        <h1>Club Details Insertion</h1>
        <div id="formnav" class="forms" style="width: 62vw;top:0vh;padding:5px;color:black"><a href="profileform.php">Profile</a><a href="skillform.php">Skill</a><a href="languageform.php">Languages</a><a href="educationform.php">Education</a><a href="internshipform.php">Internships</a><a href="publicationform.php">Publications</a><a href="projectform.php">Projects</a><a href="certificateform.php">Certificates</a><a class="nfactive" href="Clubform.php">Clubs</a></div>
    </header>
    <section class="forms" style="width: 30vw;">
        <article>
                  <h2>Enter information about any clubs you are a part of</h2>
           
                     <form name="add_name" id="add_name">  
                
                               <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
                                         <td><input style="width:20vw" type="text" name="name[]" placeholder="Enter your club Name" class="form-control name_list" /></td>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input style="width:20vw" type="text" name="name[]" placeholder="Enter your club Name" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
