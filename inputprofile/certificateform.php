      ...
      $('#submit').click(function(){            
           $.ajax({  
                ...
                {  
                     alert(data);  
                     $('#add_name')[0].reset();  
                    window.location.replace('clubform.php');
                }  
           });
      });
		 $('#skip').click(function(){
