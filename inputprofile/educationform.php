                          ...
                          <div class="table-responsive">  
                               <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
										 ...
										 <td><input type="text" name="board[]" placeholder="Enter board" class="form-control board_list" /></td>  
