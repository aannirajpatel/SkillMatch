...
<body>
    ...
    <header>
        <h1>Projects Insertion</h1>
        <div id="formnav" class="forms" style="width: 62vw;top:0vh;padding:5px;color:black"><a href="profileform.php">Profile</a><a href="skillform.php">Skill</a><a href="languageform.php">Languages</a><a href="educationform.php">Education</a><a href="internshipform.php">Internships</a><a href="publicationform.php">Publications</a><a class="nfactive" href="projectform.php">Projects</a><a href="certificateform.php">Certificates</a><a href="Clubform.php">Clubs</a></div>
      </header>
    <section class="forms"">
        <article>
                  <h2>Enter information about projects you have done</h2>
                     <form name="add_name" id="add_name">
                          
                               <table class="table table-bordered" id="dynamic_field">
                                    <tr>
                                         <td><input type="text" name="name[]" placeholder="Project domain" class="form-control name_list" /></td>  
										 <td><input type="text" name="num[]" placeholder="Project title" class="form-control num_list" /></td>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="Enter your domain of project" class="form-control name_list" /></td><td><input type="text" name="num[]" placeholder="Enter project title" class="form-control num_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
      ...
      $('#submit').click(function(){            
           $.ajax({  
                ...
                {  
                    ...
                    window.location.replace("certificateform.php");
                }  
           });  
      });
      $('#skip').click(function(){
